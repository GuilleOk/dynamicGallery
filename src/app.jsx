...
const NewResearch = () => {
  const { galerys, getItemToSearch, erasePhoto, eraseGallery, eraseTehme } = useNewResearch()
  ...
  return (
    <div className='ContainerApp'>
      ...
      <Gallerys galerys={galerys} erasePhoto={erasePhoto} eraseGallery={eraseGallery} eraseTehme={eraseTehme} />
    </div>
  )
}
